...
function Nav() {
  ...
  return (
    <div className='w-full h-[100px] flex justify-between items-center px-5 md:px-8 bg-[#FFDBB6]  '>
      <div className='w-[60px] h-[60px] bg-white flex justify-center items-center rounded-md shadow-xl'>
      <MdFastfood className='w-[30px] h-[30px] text-red-400'/>
      </div>
      ...
      <IoSearch  className='text-red-500 w-[20px] h-[20px] '/>
      ...
      <div className='w-[60px] h-[60px] bg-white flex justify-center items-center rounded-md shadow-xl relative cursor-pointer' onClick={()=>{
        ...
        <span className='absolute top-0 right-2 text-red-400 font-bold text-[18px]'>{items.length}</span>
